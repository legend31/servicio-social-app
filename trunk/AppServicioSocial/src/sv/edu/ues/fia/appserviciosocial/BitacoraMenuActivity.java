...
public class BitacoraMenuActivity extends TabActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Intent primerIntent = new Intent(this, BitacoraInsertarActivity.class);
		...
		Intent sIntent = new Intent(this, BitacoraConsultarActivity.class);
		...
		Intent tIntent = new Intent(this, BitacoraActualizarActivity.class);
		...
		Intent cIntent = new Intent(this, BitacoraEliminarActivity.class);
      ...
      //Siempre vamos a mostrar el mismo titulo
        ...
        mDrawerToggle = new ActionBarDrawerToggle(
                ...
                R.string.title_activity_bitacora_menu,  /* "open drawer" description */

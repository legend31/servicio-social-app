...
public class PantallaInicialActivity extends Activity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (tipoUsuario == 1) {
			...
			datos.add(new Lista_entrada(R.drawable.encargado, "Encargado S.S"));
		 ...
		 * datos.add(new Lista_entrada(R.drawable.estudiante, "Alumno"));
		 * datos.add(new Lista_entrada(R.drawable.aproyectos,
		 * "Asignacion Proyectos")); datos.add(new
		 * Lista_entrada(R.drawable.bitacora, "Bitacora")); datos.add(new
		 * Lista_entrada(R.drawable.cargo, "Cargo")); datos.add(new
		 * Lista_entrada(R.drawable.encargado, "Encargado S.S")); datos.add(new
		 * Lista_entrada(R.drawable.institucion, "Institucion")); datos.add(new
		 * Lista_entrada(R.drawable.solicitante, "Solicitante")); datos.add(new
		 * Lista_entrada(R.drawable.proyecto, "Proyecto")); datos.add(new
		 * Lista_entrada(R.drawable.proyectos, "Tipo Proyecto")); datos.add(new
		 * Lista_entrada(R.drawable.trabajo, "Tipo Trabajo"));
		 * 
		 * lista = (GridView) findViewById(R.id.ListView_listado);
		 * lista.setAdapter(new Lista_Adaptador(this, R.layout.entrada, datos) {
		 * 
		 * @Override public void onEntrada(Object entrada, View view) { if
		 * (entrada != null) { TextView texto_superior_entrada = (TextView) view
		 * .findViewById(R.id.textView_superior); if (texto_superior_entrada !=
		 * null) texto_superior_entrada .setText(((Lista_entrada) entrada)
		 * .getTextoEncima());
		 * 
		 * ImageView imagen_entrada = (ImageView) view
		 * .findViewById(R.id.imageView_imagen); if (imagen_entrada != null)
		 * imagen_entrada .setImageResource(((Lista_entrada) entrada)
		 * .getIdImagen()); } } });
		 */
	...
	public void onItemClick(AdapterView<?> parent, View view, int position,
		...
		if (tipoUsuario == 1) {
			...
			try {
				Class<?> clase = Class
						.forName("sv.edu.ues.fia.appserviciosocial."
								+ nombreValues);
			...
			String nombreValues = actividadesAlumno[position];
			try {
				Class<?> clase = Class
						.forName("sv.edu.ues.fia.appserviciosocial."
								+ nombreValues);

...
public class TipoTrabajoActivity extends TabActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Intent primerIntent = new Intent(this, TipoTrabajoInsertar.class);
		...
		Intent sIntent = new Intent(this, TipoTrabajoConsultar.class);
		...
		Intent tIntent = new Intent(this, TipoTrabajoModificar.class);
		...
		Intent cIntent = new Intent(this, TipoTrabajoEliminar.class);
      ...
      //Siempre vamos a mostrar el mismo titulo
        ...
        mDrawerToggle = new ActionBarDrawerToggle(
                ...
                R.string.title_activity_tipo_trabajo ,  /* "open drawer" description */

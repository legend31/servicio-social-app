...
public class CargoMenuActivity extends TabActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_cargo_menu);
		  ...
		  Intent intent1 = new Intent(this, CargoInsertarActivity.class);
		  Intent intent2 = new Intent(this, CargoActualizarActivity.class);
		  Intent intent3 = new Intent(this, CargoConsultarActivity.class);
		  Intent intent4 = new Intent(this, CargoEliminarActivity.class);

...
public class SolicitanteMenuActivity extends TabActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Intent primerIntent = new Intent(this, SolicitanteInsertarActivity.class);
		...
		Intent sIntent = new Intent(this, SolicitanteConsultarActivity.class);
		...
		Intent tIntent = new Intent(this, SolicitanteActualizarActivity.class);
		...
		Intent cIntent = new Intent(this, SolicitanteEliminarActivity.class);
